...
class Product(Base):
    ...
    product_description: Mapped[Optional[str]] = mapped_column("descricao_produto", String(1000), nullable=True)
    base_price: Mapped[Optional[float]] = mapped_column("preco_base", Float, nullable=True)
